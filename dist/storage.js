...
class MemStorage {
    ...
    seedData() {
        ...
        productsData.forEach((prod) => {
            const product = Object.assign(Object.assign({ id: this.currentProductId++ }, prod), { originalPrice: null, downloadUrl: `/downloads/${prod.title.toLowerCase().replace(/\s+/g, "-")}.zip`, rating: "4.5", reviewCount: 100, downloadCount: 500, isActive: true, createdAt: new Date(), updatedAt: new Date() });
